    ...
    <div class="footer-content">
        <div class="footer-main">
            ...
            <div class="footer-brand">
                <h3>Frederic N'DA</h3>
                <p>Artiste peintre et designer passionné, explorant l'intersection entre l'art contemporain, le design et la culture africaine à travers des créations uniques et engagées.</p>
                ...
                <div class="footer-social">
                    ...
                    <a href="https://twitter.com" class="social-link" aria-label="Twitter / X" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="https://wa.me/2250769465904" class="social-link" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="footer-column">
                ...
                <div class="footer-contact-item">
                    ...
                    <a href="mailto:contact@fredericnda.com">contact@fredericnda.com</a>
                </div>
                <div class="footer-contact-item">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="footer-newsletter" style="margin-top: 1.5rem;">
                    <p style="font-size: 0.9rem; margin-bottom: 0.5rem; color: rgba(255, 255, 255, 0.9);">Restez informé</p>
        ...
        <div class="footer-bottom">
            <p>© 2025 Frederic N'DA. Tous droits réservés. Fait avec <span class="footer-heart">♥</span> en Côte d'Ivoire</p>
