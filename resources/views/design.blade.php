...
@section('title', $pageContent->meta_title ?? 'Design Mobilier - Frederic N\'DA')
        ...
        <div class="search-container">
            <div class="search-wrapper">
                <input type="text"
                       id="searchInput"
                       class="search-input"
                       placeholder="Rechercher un meuble par nom..."
                       autocomplete="off">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.openDetailModal = function(index) {
        ...
        const imagePath = currentProductDesign.image ? '/storage/' + currentProductDesign.image : '/images/img1.jpg';

        detailImage.src = imagePath;
        detailTitle.textContent = currentProductDesign.name;
        detailPrice.textContent = currentProductDesign.formatted_price || (currentProductDesign.price + ' FCFA');
        detailDescription.textContent = currentProductDesign.description || 'Aucune description disponible.';
        detailDimensions.textContent = currentProductDesign.dimensions || 'N/A';
        detailMaterials.textContent = currentProductDesign.materials || 'N/A';
        detailStyle.textContent = currentProductDesign.style || 'N/A';
        detailYear.textContent = currentProductDesign.year || 'N/A';
    ...
    function openOrderModalWithProduct(product) {
        ...
        messageField.value = `Je souhaite commander la pièce "${product.name}" au prix de ${price}.`;
